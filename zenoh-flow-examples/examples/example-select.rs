...
#[async_std::main]
async fn main() {
    let (s1, mut r1) = link::<u8>(10, String::from("0"));
    let (s2, mut r2) = link::<u8>(10, String::from("1"));
    let (s3, mut r3) = link::<u8>(10, String::from("2"));
    let (s4, mut r4) = link::<u8>(10, String::from("3"));
