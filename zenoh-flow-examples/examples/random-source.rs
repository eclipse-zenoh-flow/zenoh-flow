...
use zenoh_flow::{
    default_output_rule, types::ZFResult, zf_data, zf_empty_state, ZFComponentOutputRule,
    ZFComponentState, ZFDataTrait, ZFPortID, ZFSourceTrait,
};
...
impl ZFComponentState for ExampleRandomSource {
    fn initial_state(
        &self,
